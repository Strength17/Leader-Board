...
export const PEOPLE = [
  {
    ...
    breakdown: [
      ...
      { section: "DAILY CHECK-INS", items: [
        { label: "Form submission", pts: 10, earned: true, dayHits: ["D1", "D2", "D3", "D6", "D7", "D8"], desc: "6 valid forms submitted. +60 total." },
      ]},
      ...
      { section: "WORK POST", items: [
        { label: "Work post (image uploaded)", pts: 5, earned: true, dayHits: ["D1", "D2", "D3", "D5", "D6", "D7", "D8"], desc: "Image uploaded on D1, D2, D3, D5, D6, D7, D8. +40 total." },
      ]},
  ...
  },
  {
    ...
    breakdown: [
      ...
      { section: "DAILY CHECK-INS", items: [
        { label: "Form submission", pts: 10, earned: true, dayHits: ["D5", "D7", "D8"], desc: "3 valid forms submitted. +30 total." },
      ]},
      { section: "FIGMA WORK", items: [
        { label: "Creativity scores", pts: null, earned: true, dayHits: ["D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8"], desc: "D1:5 \u00b7 D2:10 \u00b7 D3:10 \u00b7 D4:5 \u00b7 D5:5 \u00b7 D6:5 \u00b7 D7:5 \u00b7 D8:5. Total: +50." },
      ]},
      { section: "WORK POST", items: [
        { label: "Work post (image uploaded)", pts: 5, earned: true, dayHits: ["D5", "D7", "D8"], desc: "Image uploaded on D5, D7, D8. +65 total." },
      ]},
      { section: "WHATSAPP ENGAGEMENT", items: [
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 210, submitted: true, streakDays: 3, workDone: true, workStreakDays: 7 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
      ...
      { section: "DAILY CHECK-INS", items: [
        { label: "Form submission", pts: 10, earned: true, dayHits: ["D2", "D3", "D8"], desc: "3 valid forms submitted. +30 total." },
      ]},
      { section: "FIGMA WORK", items: [
        { label: "Creativity scores", pts: null, earned: true, dayHits: ["D1", "D2", "D3", "D5", "D6", "D7"], desc: "D1:10 \u00b7 D2:15 \u00b7 D3:10 \u00b7 D5:15 \u00b7 D6:5 \u00b7 D7:5. Total: +60." },
      ]},
      { section: "WORK POST", items: [
        { label: "Work post (image uploaded)", pts: 5, earned: true, dayHits: ["D2", "D3", "D8"], desc: "Image uploaded on D2, D3, D8. +15 total." },
      ]},
      { section: "WHATSAPP ENGAGEMENT", items: [
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 205, submitted: false, streakDays: 6, workDone: false, workStreakDays: 6 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 137, submitted: true, streakDays: 3, workDone: true, workStreakDays: 4 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
      ...
      { section: "DAILY CHECK-INS", items: [
        { label: "Form submission", pts: 10, earned: true, dayHits: ["D1", "D2", "D8"], desc: "3 valid forms submitted. +30 total." },
      ]},
      { section: "FIGMA WORK", items: [
        { label: "Creativity scores", pts: null, earned: true, dayHits: ["D1", "D2", "D6", "D8"], desc: "D1:10 \u00b7 D2:15 \u00b7 D6:5 \u00b7 D8:5. Total: +35." },
      ]},
      { section: "WORK POST", items: [
        { label: "Work post (image uploaded)", pts: 5, earned: true, dayHits: ["D1", "D2", "D6", "D8"], desc: "Image uploaded on D1, D2, D6, D8. +50 total." },
      ]},
      { section: "WHATSAPP ENGAGEMENT", items: [
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 129, submitted: false, streakDays: 3, workDone: false, workStreakDays: 3 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 115, submitted: true, streakDays: 4, workDone: true, workStreakDays: 5 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
      ...
      { section: "DAILY CHECK-INS", items: [
        { label: "Form submission", pts: 10, earned: true, dayHits: ["D2", "D4", "D7", "D8"], desc: "4 valid forms submitted. +40 total." },
        { label: "Early submission bonus", pts: 5, earned: true, dayHits: ["D2"], desc: "Submitted before 3PM on D2. +5 total." },
      ]},
      { section: "FIGMA WORK", items: [
        { label: "Creativity scores", pts: null, earned: true, dayHits: ["D6", "D7", "D8"], desc: "D6:5 \u00b7 D7:5 \u00b7 D8:5. Total: +15." },
      ]},
      { section: "WORK POST", items: [
        { label: "Work post (image uploaded)", pts: 5, earned: true, dayHits: ["D2", "D4", "D7", "D8"], desc: "Image uploaded on D2, D4, D7, D8. +45 total." },
      ]},
      { section: "WHATSAPP ENGAGEMENT", items: [
  ...
  },
  {
    ...
    allTimeTotal: 110,
    tier: "BRONZE",
    warnings: ["New joiner recovery form (D1 written on D6) \u2014 officially recorded as D6."],
    days: {
    ...
    breakdown: [
      ...
      { section: "DAILY CHECK-INS", items: [
        { label: "Form submission", pts: 10, earned: true, dayHits: ["D6", "D7", "D8"], desc: "3 valid forms submitted. +30 total." },
        { label: "Early submission bonus", pts: 5, earned: true, dayHits: ["D6", "D7"], desc: "Submitted before 3PM on D6, D7. +10 total." },
      ]},
      { section: "FIGMA WORK", items: [
        { label: "Creativity scores", pts: null, earned: true, dayHits: ["D6", "D7", "D8"], desc: "D6:10 \u00b7 D7:10 \u00b7 D8:5. Total: +25." },
      ]},
      { section: "WORK POST", items: [
        { label: "Work post (image uploaded)", pts: 5, earned: true, dayHits: ["D6", "D7", "D8"], desc: "Image uploaded on D6, D7, D8. +25 total." },
      ]},
      { section: "WHATSAPP ENGAGEMENT", items: [
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 99, submitted: false, streakDays: 1, workDone: false, workStreakDays: 1 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 82, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 30, submitted: false, streakDays: 1, workDone: false, workStreakDays: 1 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 22, submitted: false, streakDays: 1, workDone: false, workStreakDays: 1 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 15, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 13, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 12, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 10, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 9, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 8, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 7, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
  ...
  },
  {
    ...
    days: {
      ...
      D8: { pts: 5, submitted: false, streakDays: 0, workDone: false, workStreakDays: 0 },
    },
    breakdown: [
      { section: "PRE-PROGRAMME", items: [
        { label: "Pledge", pts: 5, earned: true, dayHits: null, desc: "You committed to the programme. +5 for your pledge." },
