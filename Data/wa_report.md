...
> this feeds leaderboard_sync.py.

---

## SECTION 1 — PARTICIPANT SUMMARY (≥5 draft WA pts)
...
## SECTION 2 — NEEDS ADMIN INPUT: Creativity Scores

### A. Auto-detected from admin announcements (verify before finalising)

| Name | Day | Score | Source Snippet |
|------|-----|-------|----------------|
| _none detected_ | | | |

### B. Media posted but NO admin score yet — ACTION REQUIRED
...
| Mbiydzenyuy Patience Dzekem | D2 | 1 | _____ |
| Oluwasegun Daniel Osawore | D2 | 1 | _____ |
...
- **Referral Activity**: Identified as referred by **Malialia Celine Bride**
- **Sample messages**: Hi sky graphics I'm called  Muguo malighta fienmbu in Cameroon  and a student.                             I joined this
- **Day subtotal**: +5 draft WA pts

**RUNNING TOTAL for +237 6 73 41 60 87**: +5 draft WA pts
...
- **Media**: 1 item(s) — PENDING admin creativity score
- **Interactions (counted):**
  - helped_a_member: +5 pts (matched: `~click on (75.0%)`)
  - shared_tip_or_resource: +3 pts (matched: `~tip: (75.0%)`)
  - posted_encouragement: +2 pts (matched: `~fire (75.0%)`)
- **Sample messages**: <Media omitted>
...
- **Interactions (counted):**
  - shared_tip_or_resource: +3 pts (matched: `~i found this (75.0%)`)
  - posted_encouragement: +2 pts (matched: `~good effort (73.6842105263158%)`)
- **Sample messages**: Good morning Sky Graphics. I am called Emmanuel Karol Tchouani from Cameroon and I'm a student  I joined this group beca
- **Day subtotal**: +5 draft WA pts
...
#### D4 (Day 4 — June 4, 2026)
- **Interactions (counted):**
  - posted_encouragement: +2 pts (matched: `~well done (80.0%)`)
- **Sample messages**: Well noted Thank you sir.
- **Day subtotal**: +2 draft WA pts
...
**RUNNING TOTAL for Emmanuel Karol Tchouani**: +10 draft WA pts
...
- **Interactions (counted):**
  - posted_encouragement: +2 pts (matched: `~love this (77.77777777777779%)`)
  - helped_a_member: +5 pts (matched: `~here's what you do (88.88888888888889%)`)
- **Sample messages**: I, Faith Emmanuella Busari, commit to Sky  Graphics Edition 1. I will show up  daily, post my progress honestly,  and co
...
- **Interactions (counted):**
  - posted_encouragement: +2 pts (matched: `~love this (77.77777777777779%)`)
- **Sample messages**: I, FONYUY BERINYUY TARKIGHAN, commit to Sky Graphics Edition 1. I will show up daily, post my progress honestly, and com
- **Day subtotal**: +7 draft WA pts

**RUNNING TOTAL for Fonyuy Berinyuy Tarkighan**: +9 draft WA pts
...
- **Media**: 2 item(s) — PENDING admin creativity score
- **Interactions (counted):**
  - welcome_new_member: +3 pts (matched: `~welcome to the group (75.0%)`)
  - asked_genuine_question: +3 pts (matched: `~please help (81.81818181818181%)`)
  - welcome_new_member: +3 pts (matched: `welcome`): "Welcome To Sky Graphics. Hope You enjouy your time here with us."
  - welcome_new_member: +3 pts (matched: `~glad you're here (75.0%)`)
  - asked_genuine_question: +3 pts (matched: `~please help (72.72727272727273%)`)
  - posted_encouragement: +2 pts (matched: `~fire (75.0%)`)
  - shared_tip_or_resource: +3 pts (matched: `~here's a tip (75.0%)`)
  - posted_encouragement: +2 pts (matched: `~fire (75.0%)`)
  - helped_a_member: +5 pts (matched: `~click on (75.0%)`)
  - welcome_new_member: +3 pts (matched: `welcome`): "Welcome To Sky Graphics. Hope You enjouy your time here with us."
- **Sample messages**: This message was deleted
- **Day subtotal**: +30 draft WA pts

**RUNNING TOTAL for Frank Emmanuel**: +35 draft WA pts
...
- **Media**: 4 item(s) — PENDING admin creativity score
- **Interactions (counted):**
  - welcome_new_member: +3 pts (matched: `welcome`): "Welcome to Sky Graphics Miss Dorothy Joyce"
  - helped_a_member: +5 pts (matched: `~you can try (81.81818181818181%)`)
  - welcome_new_member: +3 pts (matched: `welcome`): "Welcome to Sky Graphics Miss Dorothy Joyce"
  - asked_genuine_question: +3 pts (matched: `~how do i (87.5%)`): "Question : The grid lines are still quite visible how do I make them disappear without affecting the images?"
  - helped_a_member: +5 pts (matched: `~you can try (81.81818181818181%)`)
  - welcome_new_member: +3 pts (matched: `welcome`): "Welcome to Sky Graphics Miss Dorothy Joyce"
  - asked_genuine_question: +3 pts (matched: `~how do i (87.5%)`): "Question : The grid lines are still quite visible how do I make them disappear without affecting the images?"
  - asked_genuine_question: +3 pts (matched: `how do i`): "Question : The grid lines are still quite visible how do I make them disappear without affecting the images?"
- **Interactions (capped out — not counted):**
  - ~~shared_tip_or_resource: +3~~ (would be `~tip: (75.0%)`)
...
- **Interactions (counted):**
  ...
  - posted_encouragement: +2 pts (matched: `~love this (77.77777777777779%)`)
  - helped_a_member: +5 pts (matched: `~here's what you do (88.88888888888889%)`)
- **Sample messages**: Good morning Sir.My night was good eventhough very short
- **Day subtotal**: +19 draft WA pts

**RUNNING TOTAL for Moh Blessing Kebul**: +19 draft WA pts
...
- **Interactions (counted):**
  - shared_tip_or_resource: +3 pts (matched: `~i found this (75.0%)`)
  - posted_encouragement: +2 pts (matched: `~amazing work (75.0%)`)
- **Referral Activity**: Identified as referred by **Malialia Celine Bride**
- **Sample messages**: Good morning Sky Graphics. I am called Ngum-Nchung Blessing Kah Geh from Cameroon and I'm a student  I joined this group
- **Day subtotal**: +5 draft WA pts

**RUNNING TOTAL for Ngum-nchung Blessing Kah Geh**: +5 draft WA pts
...
- **Interactions (counted):**
  ...
  - shared_tip_or_resource: +3 pts (matched: `~i found this (75.0%)`)
  - posted_encouragement: +2 pts (matched: `~good effort (73.6842105263158%)`)
- **Referral Activity**: Identified as referred by **Frank Emmanuel**
- **Sample messages**: Good afternoon guys am NZAMEYO MBA  from Yaounde, Cameroon studying in sciences I joined this program to learn how to cr
- **Day subtotal**: +8 draft WA pts

**RUNNING TOTAL for Nzameyo Mba**: +8 draft WA pts
...
- **Media**: 1 item(s) — PENDING admin creativity score
- **Interactions (counted):**
  - welcome_new_member: +3 pts (matched: `welcome`): "Welcome @+237 6 89 55 79 07"
- **Sample messages**: <Media omitted>
- **Day subtotal**: +3 draft WA pts
...
- **Interactions (counted):**
  ...
  - posted_encouragement: +2 pts (matched: `~fire (75.0%)`)
  - helped_a_member: +5 pts (matched: `~here's what you do (88.88888888888889%)`)
- **Sample messages**: "I, Suilabayu Olga, commit to Sky Graphics Edition 1. I will show up daily, post my progress honestly, and complete this
- **Day subtotal**: +14 draft WA pts

#### D3 (Day 3 — June 3, 2026)
- **Sample messages**: The night was good, good morning @ll
- **Day subtotal**: +0 draft WA pts

**RUNNING TOTAL for Suilabayu Olga Simolen**: +14 draft WA pts
...
---
### ─── Participants with < 5 draft WA pts ───
...
- **Interactions (counted):**
  - shared_tip_or_resource: +3 pts (matched: `~i found this (75.0%)`)
- **Referral Activity**: Identified as referred by **Malialia Celine Bride**
- **Sample messages**: Hi sky graphics, I'm called Nkwain Harzel Nayuo, based in Cameroon and I'm a student  I joined this group to blend creat
- **Day subtotal**: +3 draft WA pts

**RUNNING TOTAL for +237 6 51 06 70 08**: +3 draft WA pts
...
- **Interactions (counted):**
  - posted_encouragement: +2 pts (matched: `~love this (77.77777777777779%)`)
- **Sample messages**: I AKUCHU  TOHLA TCHOSI-AMBOM  fully to sky Graphics Edition 1. I will show up daily, post my progress honestly and compl
- **Day subtotal**: +2 draft WA pts

**RUNNING TOTAL for +237 6 77 96 13 61**: +2 draft WA pts
...
- **Interactions (counted):**
  - asked_genuine_question: +3 pts (matched: `~how do i (75.0%)`)
- **Sample messages**: Hi Sky graphics, I'm Mbishitehnyi Ryan  I'm in  Cameroon  I'm a student in LSS I joined because I want to learn how to m
- **Day subtotal**: +3 draft WA pts

**RUNNING TOTAL for +237 6 82 42 26 22**: +3 draft WA pts
...
- **Interactions (counted):**
  - asked_genuine_question: +3 pts (matched: `~how do i (75.0%)`)
- **Referral Activity**: Identified as referred by **Mbishitehnyi Ryan**
- **Sample messages**: Hi Sky graphics, I'm Richard Nathan Enana  I'm working from Cameroon  I'm a student in LSS I joined because I wanted to 
- **Day subtotal**: +3 draft WA pts

**RUNNING TOTAL for +237 6 94 59 08 65**: +3 draft WA pts
...
**RUNNING TOTAL for Chunga Daina**: +3 draft WA pts
...
**RUNNING TOTAL for Dorothy Joyce Priscille**: +2 draft WA pts
...
- **Interactions (counted):**
  - posted_encouragement: +2 pts (matched: `~good effort (73.6842105263158%)`)
- **Sample messages**: Good morning everyone Am called Malialia Celine Bride from Bamenda, am a student. I joined to gain more skills because I
- **Day subtotal**: +2 draft WA pts

**RUNNING TOTAL for Malialia Celine Bride**: +2 draft WA pts
...
### Tsopmo Precious — Participant
#### D1 (Day 1 — June 1, 2026)
- **Sample messages**: "I, Tsopmo Precious, commits to Sky Graphics edition 1. I will show up daily post my progress honestly, and complete tho
- **Day subtotal**: +0 draft WA pts

**RUNNING TOTAL for Tsopmo Precious**: +0 draft WA pts

---

## ⚠️ DISCREPANCIES

### Day-number mismatch (timestamp vs. what student wrote)
_None detected._

### Unresolved phone numbers (no name found in any message)
...
### ✅ Names auto-discovered this run (intro message mining)

| Phone / Alias | Resolved Name |
|---------------|----------------|
